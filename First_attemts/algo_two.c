...
/*   Updated: 2023/01/22 16:28:08 by mstiedl          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_a(t_list **stack_a, t_list **stack_b, int divide);
...
void	ft_put_b(t_list **stack_a, t_list **stack_b, int last)
{
	t_list *b_last;
...
void	check_options(t_list **stack_a, t_list **stack_b, int last, int divide)
{
	if (!*stack_b)
	{
		...
		// the end of this ^ if adding extra moves
